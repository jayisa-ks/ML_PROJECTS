...
Exploratory data analysis is performed to identify key patterns influencing price variations.
Both Linear Regression and Polynomial Regression models are implemented,
with results showing that Polynomial Regression provides better accuracy by capturing non-linear relationships in the data.
